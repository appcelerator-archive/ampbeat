...
func (a *Ampbeat) publishIOMetrics(stats *types.StatsJSON, data *ContainerData) {
...
// create new io stats
func (a *Ampbeat) newIOStats(stats *types.StatsJSON) *IOStats {
...
func (a *Ampbeat) newIODiff(newIO *IOStats, previousIO *IOStats) *IOStatsDiff {
