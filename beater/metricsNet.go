...
func (a *Ampbeat) publishNetMetrics(stats *types.StatsJSON, data *ContainerData) {
...
func (a *Ampbeat) newNetStats(stats *types.StatsJSON) *NetStats {
...
func (a *Ampbeat) newNetDiff(newNet *NetStats, previousNet *NetStats) *NetStatsDiff {
