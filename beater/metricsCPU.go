...
func (a *Ampbeat) publishCPUMetrics(stats *types.StatsJSON, data *ContainerData) {
...
func (a *Ampbeat) newCPUStats(stats *types.StatsJSON) *CPUStats {
	var cpu = &CPUStats{
		Time:                 stats.Read,
...
func (a *Ampbeat) newCPUDiff(cpu *CPUStats) *CPUStatsDiff {
...
func (a *Ampbeat) calculateLoad(oldValue uint64, newValue uint64, duration uint64) float64 {
